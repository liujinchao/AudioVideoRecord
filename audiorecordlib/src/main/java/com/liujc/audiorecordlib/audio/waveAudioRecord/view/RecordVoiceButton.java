package com.liujc.audiorecordlib.audio.waveAudioRecord.view;
...
import com.liujc.audiorecordlib.audio.waveAudioRecord.VoiceManager;
...
public class RecordVoiceButton extends Button implements View.OnClickListener {
    ...
    private void startRecordDialog() {
        ...
        recordIndicator.setContentView(R.layout.wave_record_voice_dialog);
